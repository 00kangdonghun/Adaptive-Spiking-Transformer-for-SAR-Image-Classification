...
parser.add_argument('--resume',
                    default='/home1/danny472/Adaptive-Spiking-Transformer-for-SAR-Image-Classification/SAR/EuroSAT-SAR/output/depths_4/dim-384/train/model_best.pth.tar', # => change to your checkpoint path
...
def main():
    ...
    # using real data
    Nops, Nparams = get_model_complexity_info(model, (3, 64, 64), loader_eval, as_strings=True,
