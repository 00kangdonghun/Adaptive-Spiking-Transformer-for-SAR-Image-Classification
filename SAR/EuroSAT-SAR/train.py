...
parser.add_argument('-c', '--config', default='EuroSAT.yml', type=str, metavar='FILE',
...
parser.add_argument('-data-dir', metavar='DIR',default="/home1/danny472/Adaptive-Spiking-Transformer-for-SAR-Image-Classification/dataset/EuroSAT", #/dataset/ImageNet2012/
                    help='path to dataset')
parser.add_argument('--dataset', '-d', metavar='NAME', default='EuroSAT',
