...
parser.add_argument('-data-dir', metavar='DIR', default="/home1/danny472/Adaptive-Spiking-Transformer-for-SAR-Image-Classification/dataset/MSTAR-10classes",
...
parser.add_argument('--resume',
                    default='/home1/danny472/Adaptive-Spiking-Transformer-for-SAR-Image-Classification/Spikingformer/MSTAR-10classes-aug/output/depths_4/dim-384/train/model_best.pth.tar',
...
parser.add_argument('--no-resume-opt', action='store_true', default=True,
                    help='Test model without optimizer')
...
def main():
    ...
    # using real data
    Nops, Nparams = get_model_complexity_info(model, (3, 128, 128), loader_eval, as_strings=True,
                                              print_per_layer_stat=True, verbose=True, syops_units='Mac',
                                              param_units=' ', output_precision=3)
    # using random input
